...
use App\Http\Requests\Admin\Purpose\StoreRequest;
use App\Http\Requests\Admin\Purpose\UpdateRequest;
...
class PurposeController extends Controller
{
   /**
    ...
    public function index()
    {
        ...
        return view('admin.pages.purpose.index',compact('columns'));
    }
    ...
    public function datatable(){
        ...
        ->addColumn('actions' , function(Purpose $Purpose){
            $actions = '';
            if(Auth::user()->can('edit_settings')){
                $actions .= Icon::EditWithModal(route('admin.purpose.edit' , $Purpose->id),route('admin.purpose.update' , $Purpose->id));
            }
            if(Auth::user()->can('delete_settings')){
                $actions .= Icon::Delete(route('admin.purpose.destroy' , $Purpose->id));
            }
            return $actions;
        })
        ->rawColumns(['actions'])
    ...
    {
        return Purpose::findOrFail($id)->name;
    }
