...
class VendorController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.pages.vendor.index',compact('columns'));
    }
    ...
    public function datatable(){
        ...
        ->addColumn('actions' , function(Vendor $Vendor){
            $actions = '';
            if(Auth::user()->can('edit_settings')){
                $actions = Icon::EditWithModal(route('admin.vendor.edit' , $Vendor->id),route('admin.vendor.update' , $Vendor->id));
            }
            if(Auth::user()->can('delete_settings')){
                $actions .= Icon::Delete(route('admin.vendor.destroy' , $Vendor->id));
            }
            return $actions;
        })
        ->rawColumns(['actions'])
    ...
    {
        return Vendor::findOrFail($id)->name;
    }
