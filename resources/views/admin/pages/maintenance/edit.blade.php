    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 ml-2 mb-0">/  {{__('admin.edit_new_maintenance')}} </span>
            </div>
        </div>
    </div>
    <div class="row row-sm">
        <div class="col">
            <form action="{{ route('admin.maintenance.update',$Maintenanace->id) }}" method="post" id="store" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="d-flex justifiy-content-between">
                                            <div class="item">
                                                <input type="radio" name="requisition_type" id="maintenance" value="maintenance" {{ $Maintenanace->requisition_type == 'maintenance' ? 'checked' : '' }}>
                                                <label for="maintenance">{{ __('admin.maintenance') }}</label>
                                            </div>
                                            <div class="item">
                                                <input type="radio" name="requisition_type" id="general" value="general" {{ $Maintenanace->requisition_type == 'general' ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="requisition_for" id="requisition_for" class="form-control select2">
                                        @foreach ($employees as $employee)
                                            <option value="{{ $employee->id }}" {{ $Maintenanace->employee_id == $employee->id ? 'selected' : '' }}>{{ $employee->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="vehicle" id="vehicle" class="form-control select2">
                                        @foreach ($vehicles as $vehicle)
                                            <option value="{{ $vehicle->id }}" {{ $Maintenanace->vehicle_id == $vehicle->id ? 'selected' : '' }}>{{ $vehicle->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="maintenance_type" id="maintenance_type" class="form-control select2">
                                        @foreach ($maintenance_types as $maintenance_typ)
                                            <option value="{{ $maintenance_typ->id }}" {{ $Maintenanace->maintenance_type_id == $maintenance_typ->id ? 'selected' : '' }}>{{ $maintenance_typ->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="charge" id="charge" class="form-control" value="{{ $Maintenanace->charge }}" placeholder="{{__('admin.charge')}}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="charge_bear">{{__('admin.charge_bear')}}</label>
                                    <input type="text" name="charge_bear" id="charge_bear" value="{{ $Maintenanace->charge_bear_by }}" class="form-control" placeholder="{{__('admin.charge_bear')}}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="service_name" id="service_name" value="{{ $Maintenanace->service_name }}" class="form-control" placeholder="{{__('admin.service_name')}}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="priority" id="priority" class="form-control">
                                        @foreach ($priorities as $priority)
                                            <option value="{{ $priority }}" {{ $Maintenanace->periority == $priority ? 'selected' : '' }}>{{ __('admin.' . $priority) }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="service_date" id="service_date"  value="{{ $Maintenanace->service_date }}" class="form-control" placeholder="{{__('admin.service_date')}}">
                                </div>
                                <div class="form-group">
                                    <input type="checkbox" name="is_add_schedule" id="is_add_schedule" value="1" {{ $Maintenanace->is_add_schedule == 1 ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="remarks" id="remarks" cols="30" rows="5" class="form-control">{{ $Maintenanace->remarks }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col">
                                <table class="table">
                                    ...
                                    <tbody>
                                        @foreach ($MaintenanaceData as $data)
                                        <tr>
                                            <td>
                                                <input type="text" name="item_type_name[]" value="{{ $data->item_type_name }}" class="form-control item_type_name">
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <input type="text" name="total_amount[]" value="{{ $data->total }}" class="form-control total_amount" readonly>
                                            </td>
                                            <td>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="number" class="form-control" name="grand_total" id="grand_total" readonly value="{{ $Maintenanace->grand_total }}">
                                            </td>
                                        </tr>
                                    </tfoot>
                                </table>
