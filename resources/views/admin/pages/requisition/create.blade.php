                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="client_name" class="form-control" placeholder="{{ __('admin.client') }}">
                            </div>
                        @endif
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="driver_name" class="form-control" placeholder="{{__('admin.driven_by')}}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="vehicle_type">{{__('admin.vehicle_type')}}</label>
                                    <input type="text" name="vehicle_type" class="form-control" placeholder="{{__('admin.vehicle_type')}}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="vehicle_number">{{__('admin.vehicle_number')}}</label>
                                    <input type="text" name="vehicle_number" id="vehicle_number" class="form-control" placeholder="{{__('admin.vehicle_number')}}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="purpose_name" id="purpose" class="form-control" placeholder="{{__('admin.purpose')}}" required>
