    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 ml-2 mb-0">/  {{__('admin.add_new_purchase')}} </span>
            </div>
        </div>
    </div>
    <div class="row row-sm">
        <div class="col">
            <form action="{{ route('admin.purchase.store') }}" method="post" id="store" enctype="multipart/form-data">
                @csrf
